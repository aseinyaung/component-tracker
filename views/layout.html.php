...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title><?= isset($page_title) ? ($page_title . ' - ') : '' ?>Component Tracker</title>
    ...
    <body>
        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <a class="brand" href="#">Component Tracker</a>
        ...
        <script>window.jQuery || document.write('<script src="../views/js/vendor/jquery-1.9.1.min.js"><\/script>')</script>
